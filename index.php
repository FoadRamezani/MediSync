...
<html>
    ...
    <body>
        ...
        else if(isset($_GET['register']))
        {
            ...
            {
                $message = '<h6 class="success">*Signup Successful. Your account is created, please log in now</h6>';
            }
        }
        ?>
        <div class="hero">
            <div class="form-box">
                ...
                <form id="register" class="input-group" action="register.php" method="post">
                    ...
                    <input type="checkbox" class="check-box" name="issuperuser"><span>Admin</span>
